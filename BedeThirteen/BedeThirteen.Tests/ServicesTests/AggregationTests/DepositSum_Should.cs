namespace BedeThirteen.Tests.ServicesTests.AggregationTests
{
    ...
    [TestClass]
    public class DepositSum_Should
    {
        [TestMethod]
        [DataRow(1)]
        [DataRow(2)]
        ...
        public async Task ReturnSum_WhenInput_Isvalid(int numberOfTransactions)
        {
            ...
            var stakeTransactionType = new TransactionType() { Name = "Deposit", };
            ...
            using (var context = new BedeThirteenContext(options))
            {
                ...
                result = await sut.DepositSum(DateTime.MinValue, DateTime.MaxValue);
            }
        ...
        public async Task ReturnStakeOfUser_WhenId_IsGiven()
        {
            ...
            using (var context = new BedeThirteenContext(options))
            {
                ...
                // Act
                var result = await sut.DepositSum(DateTime.MinValue, DateTime.MaxValue, mockUser.Id);
        ...
        public async Task ReturnZero_TimeInterval_IsEmpty()
        {
            ...
            using (var context = new BedeThirteenContext(options))
            {
                ...
                // Act
                var result = await sut.DepositSum(DateTime.Now, DateTime.MaxValue);
