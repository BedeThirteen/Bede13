    ...
    public class Withdraw_Should
    {
        ...
        public async Task ReturnSum_WhenInput_Isvalid(int numberOfTransactions)
        {
            ...
            using (var context = new BedeThirteenContext(options))
            {
                ...
                result = await sut.WithdrawSum(DateTime.MinValue, DateTime.MaxValue);
            }
        ...
        public async Task ReturnStakeOfUser_WhenId_IsGiven()
        {
            ...
            using (var context = new BedeThirteenContext(options))
            {
                ...
                // Act
                var result = await sut.WithdrawSum(DateTime.MinValue, DateTime.MaxValue, mockUser.Id);
        ...
        public async Task ReturnZero_TimeInterval_IsEmpty()
        {
            ...
            using (var context = new BedeThirteenContext(options))
            {
                ...
                // Act
                var result = await sut.WithdrawSum(DateTime.Now, DateTime.MaxValue);
